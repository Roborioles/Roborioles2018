...
OI::OI() {
    ...
    frc::SmartDashboard::PutData("AutoDrive", new AutoDrive(5));
    frc::SmartDashboard::PutData("AutoRotate", new AutoRotate(30,.5));
    frc::SmartDashboard::PutData("ElevateInit", new ElevateInit());
